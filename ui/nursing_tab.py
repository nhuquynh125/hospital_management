...
from PyQt6.QtWidgets import (
    ...
    QDateTimeEdit, QDoubleSpinBox, QSpinBox, QFrame, QGroupBox, QTabWidget
)
...
class NursingTab(QWidget):
    ...
    def _build_ui(self):
        ...
        self.status_cb.addItems(["Tất cả tình trạng","Ổn định","Cần theo dõi","Nặng","Nguy kịch","Xuất viện"])
